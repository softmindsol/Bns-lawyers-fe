  ...
  return (
    ...
    <div className="flex w-full px-20 flex-col h-[100vh] bg-white">
      ...
      <div className="flex justify-between items-center p-6">
        {isNewChat && <h2 className="text-xl font-normal">Hi, Welcome Sam! 👋</h2>}
      ...
      {isNewChat ? (
        <div className="flex-1 flex flex-col justify-center items-center px-4 -mt-20">
          <div className="text-center space-y-8 max-w-xl w-full">
            <h1 className="text-2xl font-semibold text-[#0A2540] mb-8">What can I help with?</h1>
              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter' && e.target.value.trim()) {
                    handleSendMessage({ text: e.target.value.trim(), file: null });
                    e.target.value = '';
                  }
                }}
              />
